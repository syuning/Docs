...
import { UserModalComponent } from './tsdb-table/tsdb-detail/user/user-create/user-create.component';
import { UserEditComponent } from './tsdb-table/tsdb-detail/user/user-edit/user-edit.component';
import { UserResetComponent } from './tsdb-table/tsdb-detail/user/user-reset/user-reset.component';
